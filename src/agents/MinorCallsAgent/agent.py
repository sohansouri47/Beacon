...
class MinorCallsAgent:
    def __init__(self):
        ...
        self._runner = Runner(
            app_name=AgentPrompts.MinorCallsAgent.NAME,
            agent=self._agent,
    ...
    def _build_agent(self) -> LlmAgent:
        return LlmAgent(
            name=AgentPrompts.MinorCallsAgent.NAME,
            instruction=AgentPrompts.MinorCallsAgent.INSTRUCTION,
            description=AgentPrompts.MinorCallsAgent.DESCRIPTION,
        ...
        async for event in self._runner.run_async(
            ...
            if event.is_final_response():
                ...
                yield {
                    ...
                    "updates": "Minor Calls Agent is providing first aid guidance...",
                }
